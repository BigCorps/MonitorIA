...
> **Versão atual:** 1.0.3  
> **Agent:** 1.0.3  
> **Status:** versão final publicada e em lançamento comercial.  
> Documentos e migrations que citam versões anteriores permanecem no repositório como histórico técnico e não definem a versão atual.
