    ...
    <main className="dashboard-shell">
      ...
      >
        <header className="dashboard-header">
          <div>
            ...
            <p>
              ...
              organização{" "}
              {organization.name}, sem
              misturar configurações
              técnicas com a rotina
              diária.
            </p>
          </div>
        ...
        >
          ...
          >
            <span>
              PESQUISE DO SEU JEITO
            </span>
            <h2>
              Use a Pesquisa IA do
              MonitorIA ou conecte a IA
              que sua equipe já utiliza.
            </h2>
            <p>
              Pergunte o que aconteceu,
              compare períodos, encontre
              evidências e consulte a
              operação pelo MonitorIA,
              ChatGPT, Claude ou Cursor.
            </p>

            <div
              className={
                styles.integrationChips
              }
            >
              <span>MonitorIA</span>
              <span>ChatGPT</span>
